...
class TestSummarizeCommand:
    ...
    @patch("main.download_audio", return_value="/tmp/test.wav")
    @patch("main.os.path.exists", return_value=False)
    def test_summarize_turkish_output(self, mock_exists, mock_dl, mock_title, mock_transcribe, mock_translate, mock_summarize):
        runner = CliRunner()
    ...
    @patch("main.download_audio", return_value="/tmp/test.wav")
    @patch("main.os.path.exists", return_value=False)
    def test_summarize_english_output(self, mock_exists, mock_dl, mock_title, mock_transcribe, mock_translate, mock_summarize):
        runner = CliRunner()
...
class TestPlanCommand:
    ...
    @patch("main.download_audio", return_value="/tmp/test.wav")
    @patch("main.os.path.exists", return_value=False)
    def test_plan_with_url(self, mock_exists, mock_dl, mock_title, mock_transcribe, mock_translate, mock_summarize, mock_rec, mock_plan):
        runner = CliRunner()
